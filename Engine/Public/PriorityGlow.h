...
class CPriorityGlow final : public CDeferred
{
private:
	CPriorityGlow(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CPriorityGlow() = default;
...
private:
	list<class CGameObject*> m_PriorityGlowObjects = {};

public:
	static CPriorityGlow* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
