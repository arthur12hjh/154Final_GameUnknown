...
HRESULT CGameInstance::Begin_MRT(const _wstring& strMRTTag, ID3D11DepthStencilView* pDSV, _bool bIsOnlyDepth)
{
	return m_pTarget_Manager->Begin_MRT(strMRTTag, pDSV, bIsOnlyDepth);
}
