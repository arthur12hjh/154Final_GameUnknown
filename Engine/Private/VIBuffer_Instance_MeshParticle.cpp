...
CVIBuffer_Instance_MeshParticle::CVIBuffer_Instance_MeshParticle(ID3D11Device* pDevice, ID3D11DeviceContext* pContext) :
	CVIBuffer_Instance(pDevice, pContext)
{
}

CVIBuffer_Instance_MeshParticle::CVIBuffer_Instance_MeshParticle(const CVIBuffer_Instance_MeshParticle& Prototype) :
...
HRESULT CVIBuffer_Instance_MeshParticle::Initialize_Prototype(const INSTANCE_DESC* pInstanceDesc)
{
	const MESH_PARTICLE_INSTANCE_DESC* pDesc = static_cast<const MESH_PARTICLE_INSTANCE_DESC*>(pInstanceDesc);
...
HRESULT CVIBuffer_Instance_MeshParticle::Initialize(void* pArg)
{
...
HRESULT CVIBuffer_Instance_MeshParticle::Render(_uint iIndex)
{
...
HRESULT CVIBuffer_Instance_MeshParticle::Bind_MatrialTexture(CShader* pShader, _uint iMeshIndex, const _char* pConstantName, aiTextureType eTextureType, _uint TextureIndex)
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
_uint CVIBuffer_Instance_MeshParticle::GetModelNumMeshes()
{
	return m_pModel->Get_NumMeshes();
}

HRESULT CVIBuffer_Instance_MeshParticle::Bind_Resource(_uint iMeshIndex)
{
	if (nullptr == m_pModel)
		return E_FAIL;
...
CVIBuffer_Instance_MeshParticle* CVIBuffer_Instance_MeshParticle::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const INSTANCE_DESC* pInstanceDesc)
{
	CVIBuffer_Instance_MeshParticle* pVIBufferInstanceModel = new CVIBuffer_Instance_MeshParticle(pDevice, pContext);
...
CComponent* CVIBuffer_Instance_MeshParticle::Clone(void* pArg)
{
	CVIBuffer_Instance_MeshParticle* pVIBufferInstanceModel = new CVIBuffer_Instance_MeshParticle(*this);
...
void CVIBuffer_Instance_MeshParticle::Free()
{
	__super::Free();
