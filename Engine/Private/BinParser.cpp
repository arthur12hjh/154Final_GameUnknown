...
#pragma region OLD_VERSION_PARSER
...
HRESULT CBinParser::ReadBinx(const _char* pModelFilePath, MODEL_TYPE eType, binModel** ppOut)
{
	ifstream fileBinaryStream;
	fileBinaryStream.open(pModelFilePath, ios_base::binary);
...
HRESULT CBinParser::ReadBinMorph(const _char* pModelFilePath, MODEL_TYPE eType, binModel** ppOut)
{
	ifstream fileBinaryStream;
	fileBinaryStream.open(pModelFilePath, ios_base::binary);
...
HRESULT CBinParser::WriteBinx(const _char* pModelFilePath, MODEL_TYPE eType, binModel** ppOut)
{
	ofstream fileBinaryStream;
	fileBinaryStream.open(pModelFilePath, ios_base::binary);
	...
	if (true)
	{
		...
		for (size_t j = 0; j < pModel->iNumMaterials; ++j)
		{
			...
			WriteString(fileBinaryStream, matTmp.szName);
		}
...
HRESULT CBinParser::WriteBinMorph(const _char* pModelFilePath, MODEL_TYPE eType, binModel** ppOut)
{
	ofstream fileBinaryStream;
	fileBinaryStream.open(pModelFilePath, ios_base::binary);
