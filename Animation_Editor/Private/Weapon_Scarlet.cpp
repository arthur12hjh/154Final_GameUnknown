...
CWeapon_Scarlet::CWeapon_Scarlet(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CPartObject{ pDevice, pContext }
{
}

CWeapon_Scarlet::CWeapon_Scarlet(const CWeapon_Scarlet& Prototype)
	: CPartObject{ Prototype }
{
}

HRESULT CWeapon_Scarlet::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CWeapon_Scarlet::Initialize(void* pArg)
{
...
void CWeapon_Scarlet::Priority_Update(_float fTimeDelta)
{
...
void CWeapon_Scarlet::Update(_float fTimeDelta)
{
...
void CWeapon_Scarlet::Late_Update(_float fTimeDelta)
{
...
HRESULT CWeapon_Scarlet::Render()
{
...
HRESULT CWeapon_Scarlet::Render_Shadow()
{
...
HRESULT CWeapon_Scarlet::Ready_Components()
{
	/* Com_Model */
	if (FAILED(__super::Add_Component(ENUM_CLASS(LEVEL::EDITOR), TEXT("Prototype_Component_Model_Scarlet_Weapon"),
...
HRESULT CWeapon_Scarlet::Bind_ShaderResources()
{
...
CWeapon_Scarlet* CWeapon_Scarlet::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CWeapon_Scarlet* pInstance = new CWeapon_Scarlet(pDevice, pContext);
...
CGameObject* CWeapon_Scarlet::Clone(void* pArg)
{
	CWeapon_Scarlet* pInstance = new CWeapon_Scarlet(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CWeapon_Scarlet");
		Safe_Release(pInstance);
	}
