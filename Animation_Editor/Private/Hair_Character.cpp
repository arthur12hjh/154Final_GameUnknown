...
CHair_Character::CHair_Character(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
	: CPartObject{ pDevice, pContext }
{
}

CHair_Character::CHair_Character(const CHair_Character& Prototype)
	: CPartObject{ Prototype }
{
}


HRESULT CHair_Character::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CHair_Character::Initialize(void* pArg)
{
	HAIR_CHARACTER_DESC* pDesc = static_cast<HAIR_CHARACTER_DESC*>(pArg);
...
void CHair_Character::Priority_Update(_float fTimeDelta)
{
	int a = 10;
}

void CHair_Character::Update(_float fTimeDelta)
{
...
void CHair_Character::Late_Update(_float fTimeDelta)
{
...
HRESULT CHair_Character::Render()
{
...
HRESULT CHair_Character::Render_Shadow()
{
...
HRESULT CHair_Character::Ready_Components()
{
	/* Com_Model */
	if (FAILED(__super::Add_Component(ENUM_CLASS(LEVEL::EDITOR), TEXT("Prototype_Component_Model_Hair_Eve"),
...
HRESULT CHair_Character::Bind_ShaderResources()
{
...
HRESULT CHair_Character::Bind_BoneToPartBody(void* pArg)
{
...
CHair_Character* CHair_Character::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CHair_Character* pInstance = new CHair_Character(pDevice, pContext);

	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CHair_Character");
...
CGameObject* CHair_Character::Clone(void* pArg)
{
	CHair_Character* pInstance = new CHair_Character(*this);

	if (FAILED(pInstance->Initialize(pArg)))
	{
		MSG_BOX("Failed to Cloned : CHair_Character");
		Safe_Release(pInstance);
	}
