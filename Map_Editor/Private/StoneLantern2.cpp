...
{
	/* Com_Model */
	if (FAILED(__super::Add_Component(ENUM_CLASS(LEVEL::VILLAGE), TEXT("Prototype_Component_Model_StoneLantern2"),
	...
	OBBDesc.vSize = _float3(1.f, 2.f, 1.f);
	OBBDesc.vCenter = _float3(0.f, 1.7f, 0.f);
