...
namespace Tool_Map
{
	...
	enum class ADD_OBJECT { BAMBOO, REED, ROCK1, ROCK2, ROCK3, ROCK4, ROCK5, ROCK6, ROCK7, ROCK8, CHERRYBLOSSOM1, CHERRYBLOSSOM2, CHERRYBLOSSOM3, CHERRYBLOSSOM4, CHERRYBLOSSOM5,
