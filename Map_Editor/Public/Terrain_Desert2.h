...
class CTerrain_Desert2 final : public CGameObject
{
public:
...
private:
	CTerrain_Desert2(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTerrain_Desert2(const CTerrain_Desert2& Prototype);
	virtual ~CTerrain_Desert2() = default;
...
public:
	static CTerrain_Desert2* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
