...
class CTerrain_Desert3 final : public CGameObject
{
public:
...
private:
	CTerrain_Desert3(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTerrain_Desert3(const CTerrain_Desert3& Prototype);
	virtual ~CTerrain_Desert3() = default;
...
public:
	static CTerrain_Desert3* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
