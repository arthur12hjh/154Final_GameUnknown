...
class CTerrain_Desert4 final : public CGameObject
{
public:
...
private:
	CTerrain_Desert4(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CTerrain_Desert4(const CTerrain_Desert4& Prototype);
	virtual ~CTerrain_Desert4() = default;
...
public:
	static CTerrain_Desert4* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
