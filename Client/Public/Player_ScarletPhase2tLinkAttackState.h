...
class CPlayer_ScarletPhase2tLinkAttackState final : public CPlayerState
{
private:
	CPlayer_ScarletPhase2tLinkAttackState();
	virtual ~CPlayer_ScarletPhase2tLinkAttackState() = default;
