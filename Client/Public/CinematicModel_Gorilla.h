...
class CCinematicModel_Gorilla final : public CCinematicObject
{
private:
	CCinematicModel_Gorilla(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CCinematicModel_Gorilla(const CCinematicModel_Gorilla& Prototype);
	virtual ~CCinematicModel_Gorilla() = default;
