...
class CPlayer_BattleIdleState final : public CPlayerState
{
private:
	CPlayer_BattleIdleState();
	virtual ~CPlayer_BattleIdleState() = default;
...
public:
	static	CPlayer_BattleIdleState* Create(void* pArg);
