...
class CPlayer_CorpseInteractionState final : public CPlayerState
{
private:
	CPlayer_CorpseInteractionState(void* pArg);
	virtual ~CPlayer_CorpseInteractionState() = default;
...
public:
	static	CPlayer_CorpseInteractionState* Create(void* pArg);
