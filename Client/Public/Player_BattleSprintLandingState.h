...
class CPlayer_BattleSprintLandingState final : public CPlayerState
{
public:
	enum class JUMP_TYPE { RUN, WALK, IDLE };
private:
	CPlayer_BattleSprintLandingState();
	virtual ~CPlayer_BattleSprintLandingState() = default;
...
public:
	static	CPlayer_BattleSprintLandingState* Create(void* pArg);
