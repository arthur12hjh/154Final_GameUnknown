...
class CTask_ScarletHit : public CTask
{
protected:
	CTask_ScarletHit();
	virtual ~CTask_ScarletHit() = default;
...
private:
	...
	const CHARACTER_SKILL_DESC*			m_pSkill_Data = { nullptr };
...
public:
	static	CTask_ScarletHit*					Create(CBehaviorTree* pOwnerTree);
