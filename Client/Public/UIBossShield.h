...
class CUIBossShield final : public CUIBase
{
private:
	CUIBossShield(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CUIBossShield(const CUIBossShield& Prototype);
	virtual ~CUIBossShield() = default;
...
public:
	static CUIBossShield* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
