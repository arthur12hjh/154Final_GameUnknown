...
class CPlayer_SheatheHairpin final : public CPlayerState
{
private:
	CPlayer_SheatheHairpin();
	virtual ~CPlayer_SheatheHairpin() = default;
...
public:
	static	CPlayer_SheatheHairpin* Create(void* pArg);
