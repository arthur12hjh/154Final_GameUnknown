...
class CPlayer_ParrySuccessState final : public CPlayerState
{
private:
	CPlayer_ParrySuccessState();
	virtual ~CPlayer_ParrySuccessState() = default;
...
public:
	static	CPlayer_ParrySuccessState* Create(void* pArg);
