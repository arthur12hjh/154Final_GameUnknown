...
PS_OUT PS_MAIN_MI_CH_M_NA_961_Head(PS_IN In)
{
    PS_OUT Out;
...
PS_OUT PS_MAIN_MI_CH_M_NA_961_Eyebrow(PS_IN In)
{
    PS_OUT Out;
...
PS_OUT PS_MAIN_MI_CH_M_NA_961_Eyes(PS_IN In)
{
    PS_OUT Out;
...
PS_OUT PS_MAIN_MI_CH_M_NA_961_Lens(PS_IN In)
{
    PS_OUT Out;
...
PS_OUT PS_MAIN_MI_CH_M_NA_961_Eyelashes(PS_IN In)
{
    PS_OUT Out;
...
PS_OUT PS_MAIN_MI_CH_M_NA_961_Tearline(PS_IN In)
{
    PS_OUT Out;
...
PS_OUT PS_MAIN_MI_CH_M_NA_961_EyeBlend(PS_IN In)
{
    PS_OUT Out;
...
PS_OUT PS_MAIN_MI_CH_M_NA_961_NoseShadow(PS_IN In)
{
    PS_OUT Out;
...
PS_OUT PS_MAIN_MI_CH_M_NA_961_Teeth(PS_IN In)
{
    PS_OUT Out;
...
technique11 DefaultTechnique
{
    ...
    pass MI_CH_M_NA_961_Teeth
    {
        ...
        VertexShader = compile vs_5_0 VS_MAIN();
        GeometryShader = NULL;
        PixelShader = compile ps_5_0 PS_MAIN_MI_CH_M_NA_961_Teeth();
    }
