...
CCorpse::CCorpse(const CCorpse& Prototype)
...
void CCorpse::Priority_Update(_float fTimeDelta)
{
}

void CCorpse::Update(_float fTimeDelta)
{
...
void CCorpse::Late_Update(_float fTimeDelta)
{
...
HRESULT CCorpse::Ready_Components(const _tchar* pComponentTag)
{
	/* Com_Model */
...
void CCorpse::SetCullingCollider(_uint iObjectID)
{
...
_uint CCorpse::Object_Number(const _tchar* pComponentTag)
{
...
HRESULT CCorpse::Begin_OverlapCallBack()
{
	return S_OK;
}

HRESULT CCorpse::End_OverlapCallBack()
{
	return S_OK;
}

void CCorpse::Excute_CallBack(CGameObject* pActionObject)
{
}
...
CGameObject* CCorpse::Clone(void* pArg)
{
	...
	{
		MSG_BOX("Failed to Cloned : CCorpse");
		Safe_Release(pInstance);
	}
