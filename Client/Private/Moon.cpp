...
{
	/* Com_Model */
	if (FAILED(__super::Add_Component(ENUM_CLASS(LEVEL::LEVEL_PROB), TEXT("Prototype_Component_Model_Moon"),
...
HRESULT CMoon::Bind_ShaderResources()
{
	...
	if (FAILED(m_pTransformCom->Bind_ShaderResource(m_pShaderCom, "g_WorldMatrix")))
		return E_FAIL;
	if (FAILED(m_pShaderCom->Bind_RawValue("g_MoonColorFactor", &m_vFactorColor, sizeof(_float4))))
		return E_FAIL;
