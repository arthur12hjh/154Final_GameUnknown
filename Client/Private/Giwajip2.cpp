...
{
	/* Com_Model */
	if (FAILED(__super::Add_Component(ENUM_CLASS(LEVEL::LEVEL_PROB), TEXT("Prototype_Component_Model_Giwajip2"),
	...
	OBBDesc.vSize = _float3(20.f, 15.f, 20.f);
	OBBDesc.vCenter = _float3(0.f, 13.f, -9.f);
