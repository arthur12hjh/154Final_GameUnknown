...
{
	/* Com_Model */
	if (FAILED(__super::Add_Component(ENUM_CLASS(LEVEL::LEVEL_PROB), TEXT("Prototype_Component_Model_Stair"),
	...
	/* Com_Model_COL */
	_wstring strComponentTag = TEXT("Prototype_Component_Model_Stair");
	...
	tUserData.szActorTag = TEXT("Stair_Actor");
