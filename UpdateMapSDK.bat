...
xcopy			/y		.\Engine\Bin\Debug\Engine.dll					.\Map_Editor\Bin\Debug\
xcopy			/y		.\Engine\Bin\Debug\Engine.lib					.\EngineSDK\Lib\Debug\

xcopy			/y		.\Engine\Bin\Release\Engine.dll					.\Map_Editor\Bin\Release\
...
xcopy			/y		.\Engine\Bin\ShaderFiles\*.*				.\Map_Editor\Bin\ShaderFiles\
xcopy			/y/s		.\Engine\Bin\EngineResource\*.*					.\Map_Editor\Bin\EngineResource\